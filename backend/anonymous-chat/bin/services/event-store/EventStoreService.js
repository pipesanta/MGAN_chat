...
const AnonymousChatEventConsumer = require("../../domain/AnonymousChatEventConsumer")();
 ...
 * Micro-BackEnd key
 */
const mbeKey = "ms-anonymous-chat_mbe_anonymous-chat";
  ...
  generateFunctionMap() {
    return {
      ...
      anonymousMessageArrived: {
        fn: AnonymousChatEventConsumer.handleAnonymousMessageArrived$,
        obj: AnonymousChatEventConsumer
      }
    };
  }
